...
O resultado da votação precisa ser informado para o restante da plataforma, isso deve ser feito através de mensageria. Quando a sessão de votação fechar, poste uma mensagem com o resultado da votação.
